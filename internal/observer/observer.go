...
func (o *Multi) OnToken(ctx context.Context, token string) error {
	for _, obs := range o.observers {
...
func (o *Multi) OnEnd(ctx context.Context) error {
	for _, obs := range o.observers {
...
func (o *Multi) OnError(ctx context.Context, err error) error {
	for _, obs := range o.observers {
...
func (o *Multi) OnImage(ctx context.Context, imageId string) error {
	for _, obs := range o.observers {
...
func (o *Multi) OnToolCall(ctx context.Context, toolName string, args any) error {
	for _, obs := range o.observers {
...
func (o *Multi) OnToolCallEnd(ctx context.Context, toolName string, result any) error {
	for _, obs := range o.observers {
...
func WithObserver(ctx context.Context, observer ...Observer) context.Context {
	...
	return context.WithValue(ctx, observerKey, NewMulti(observer...))
}
