...
| [`packages/chat/src/scufris_chat/README.md`](packages/chat/src/scufris_chat/README.md) | The conversation Scufris owns: the two tables, the transcript position, the typed actor, the connection-passing rule |
