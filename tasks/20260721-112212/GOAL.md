...
- [ ] 20260721-112428 (p52, F0) quick UI polish bugs (SSE reattach on select, status poll interval, empty states)
- [ ] 20260721-112429 (p50, B1) backend surface cleanup (Codex/Claude only, mock dev-flag, drop exec, per-backend model, labels)
