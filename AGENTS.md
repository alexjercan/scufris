...
| `packages/chat/src/scufris_chat/README.md` | The conversation and event tables, the `event_seq` invariant, the typed actor, the connection-passing rule |
