...
| `packages/chat/src/scufris_chat/README.md` | The conversation, event and delivery tables, the `event_seq` invariant, the typed actor, the per-channel delivery guarantee, the connection-passing rule |
